    ...
    return (
        <div className="p-8 mb-12 bg-gradient-to-b from-gray-50 to-gray-200 flex flex-col items-center">
            <header className="text-center mb-10">
                <h1 className="text-4xl font-bold text-gray-900 mb-4">CSS Grid Layout Generator</h1>
            ...
            <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="bg-white shadow-lg rounded-lg p-6 lg:col-span-1">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">Grid Parameters</h2>

                    <div className="mb-4">
                        <label className="text-gray-700">Number of Columns:</label>
                        <input
                            type="number"
                            value={columns}
                            min={1}
                    ...
                    <div className="mb-4">
                        <label className="text-gray-700">Number of Rows:</label>
                        <input
                            type="number"
                            value={rows}
                            min={1}
                    ...
                    <div className="mb-4">
                        <label className="text-gray-700">Gap (px):</label>
                        <input
                            type="number"
                            value={gap}
                            min={0}
                    ...
                    <div className="mb-4">
                        <label className="text-gray-700">Column Template:</label>
                        <input
                            type="text"
                            value={colTemplate}
                    ...
                    <div className="mb-4">
                        <label className="text-gray-700">Row Template:</label>
                        <input
                            type="text"
                            value={rowTemplate}
                        ...
                        <div className="mt-6">
                            ...
                            {selectedItems.map(index => (
                                <div key={index} className="mb-4">
                                    <h3 className="text-xl text-gray-800 mb-2">Item {index + 1}</h3>
                                    <div className="mb-2">
                                        <label className="text-gray-700">Column Span:</label>
                                        <input
                                            type="number"
                                    ...
                                    <div>
                                        <label className="text-gray-700">Row Span:</label>
                                        <input
                                            type="number"
                ...
                <div className="bg-gray-100 shadow-lg rounded-lg p-6 lg:col-span-2">
                    ...
                    <div
                        id="grid-preview"
                        className="w-full h-64 bg-gray-200 grid"
                        style={{
                    ...
                    >
                        {Array.from({ length: columns * rows }).map((_, i) => (
                            <div
                                key={i}
                                className={`bg-gray-300 flex justify-center items-center text-black cursor-pointer ${selectedItems.includes(i) ? 'ring-4 ring-blue-300' : ''}`}
                                style={{
                    ...
                    <textarea
                        ...
                        className="w-full border rounded p-2 bg-gray-100 text-black mt-4"
                        rows={5}
                        style={{ resize: 'none' }}
                    />
